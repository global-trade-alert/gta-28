...
data1.wto = data1[data1$Data == "WTO",]
data1.gta = data1[data1$Data == "GTA",]
...
#1.
ggplot(data1.wto, aes(x = Year, y = Investigations, fill = Country))+ 
  geom_col()+
  ylim(0, 60)

ggplot(data1.gta, aes(x = Year, y = Investigations, fill = Country))+ 
  geom_col()+
  ylim(0, 60)
