...
subsidy.chapter = "L"
cut.off = "2019-12-31"
relevant.juristiction = "United States of America"
path.out = "0 dev/gta-28-sh/data/Subsidies USA/"
...
saveRDS(data, paste0(path.out, "Shares.USA.RData"))
write.xlsx(data, paste0(path.out, "Shares.USA.xlsx"))
