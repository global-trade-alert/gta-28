...
path.in = "0 dev/gta-28-sh/data/Subsidies USA/"
path.gta = "0 report production/GTA 28/tables & figures/USA/"

################################################################################
# 1. get data  -----------------------------------------------------------------


data = readRDS(paste0(path.in, "Shares.USA.RData"))
...
p1 = ggplot(data, aes(x = share.of.export.value, y = share.of.interventions))+
  ...
  labs(title =  "United States of America share of exports to share of number of subsidies per sector (3 digit CPC)", 
